...
/// Signup page - Stateless for better performance and maintainability.
        ...
        body: BlocConsumer<AuthBloc, AuthState>(
          ...
          builder: (context, state) {
            ...
            return Padding(
              ...
              child: _SignupForm(isLoading: isLoading),
            );
          },
        ),
      ),
    ...
    return Form(
      ...
      child: Column(
        ...
        children: [
          ...
          // Confirm password field using common widget
          CustomTextField(
